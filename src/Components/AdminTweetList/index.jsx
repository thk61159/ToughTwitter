  ...
  return (
    <div className={styles['container']}>
      ...
      <main className={styles['user-tweets']}>
        {data.map((d) => (
          <AdminTweetBox key={d.id} id={d.id} avatar={d.poster.avatar} account={d.poster.account} name={d.poster.name} description={d.description} time={d.createdAt} deleteTweet={deleteTweet} />
        ))}
      </main>
    </div>
  );
